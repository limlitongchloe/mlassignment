...
with tab2:
    ...
    if st.button('Predict Price'):
        ...
        input_data = [[ng_dict[pred_neighbourhood_group],pred_neighbourhood,pred_latitude,pred_longitude,room_type_dict[pred_room_type],pred_minimum_nights,pred_reviews_per_month,pred_calculated_host_listings_count]]
        input_df = pd.DataFrame(input_data, columns=[ng_dict[pred_neighbourhood_group],pred_neighbourhood,pred_latitude,pred_longitude,room_type_dict[pred_room_type],pred_minimum_nights,pred_reviews_per_month,pred_calculated_host_listings_count])
